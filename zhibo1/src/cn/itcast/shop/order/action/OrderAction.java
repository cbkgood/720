...
import userinfofind.userinfofind;
/**
 * 订单Action类
 * 
 * @author 传智.郭嘉
...
//	}
	...
	private userinfofind userinfo=new userinfofind();
	public String userfindByUid() {
		// 获得用户的id.
		User existUser = (User) ServletActionContext.getRequest().getSession()
				.getAttribute("existUser");
		// 获得用户的id
		...
		classes = userinfo.hashcode(uid);
		ServletActionContext.getRequest().getSession()
				.setAttribute("classes", classes);
		return "userfindByUid";
	}
}

...
<HTML>
	...
	这是自定义的编辑页面
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="editproduct" method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<input type="text" name="pid" value="<s:property value="model.pid"/>">
					</td>
				</tr>
				<tr>

...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('0104','01','课程管理');
		d.add('010401','0104','课程管理','${pageContext.request.contextPath}/adminProduct_findAll.action?page=1','','mainFrame');
		d.add('0105','01','选课管理');
		d.add('010501','0105','选课管理','${pageContext.request.contextPath}/adminOrder_findAll.action?page=1','','mainFrame');
		document.write(d);
		//-->
	</script>
</div>	</td>

...
<div class="container productContent">
		...
		<div class="span18 last">
			...
			<div class="name">课程名：<s:property value="model.pname"/></div>
			<div class="sn">
				<div>课程编号：<s:property value="model.pid"/></div>
			</div>
			<div class="info">
				<dl>
					<dt>课程评分:</dt>
			...
			<form id="cartForm" action="addClass" >
				<input type="hidden" name="pid" value="<s:property value="model.pid"/>"/>
				<div class="action">
					<div>
							<input value="加入课程" type="submit"/>
					</div>
				</div>
			</form>
...
<div class="container footer">
	...
	<div class="span24">
		<div class="copyright">Copyright © 2017 720度全景慕课直播系统 版权所有</div>
	</div>
</div>
</body>
</html>